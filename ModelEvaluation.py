...
class ModelEvaluation():
    ...
    def visualiseResults(self, actStr, processedData):
        ...
        try:
            ...
            axarr[0,0].axis('off')
            axarr[1,0].imshow(orig_data[10])
            axarr[1,0].axis('off')
            axarr[2,0].imshow(orig_data[25])
            axarr[2,0].axis('off')
            axarr[3,0].imshow(orig_data[35])
            axarr[3,0].axis('off')
            
            axarr[0,1].set_title("Encoded")
            axarr[0,1].imshow(enc_out[0])
            axarr[0,1].axis('off')
            axarr[1,1].imshow(enc_out[10])
            axarr[1,1].axis('off')
            axarr[2,1].imshow(enc_out[25])
            axarr[2,1].axis('off')
            axarr[3,1].imshow(enc_out[35])
            axarr[3,1].axis('off')

            axarr[0,2].set_title("Decoded")
            axarr[0,2].imshow(dec_out[0])
            axarr[0,2].axis('off')
            axarr[1,2].imshow(dec_out[10])
            axarr[1,2].axis('off')
            axarr[2,2].imshow(dec_out[25])
            axarr[2,2].axis('off')
            axarr[3,2].imshow(dec_out[35])
            axarr[3,2].axis('off')

            axarr[0,3].set_title("Diff image")
            axarr[0,3].imshow(diff_data[0])
            axarr[0,3].axis('off')
            axarr[1,3].imshow(diff_data[10])
            axarr[1,3].axis('off')
            axarr[2,3].imshow(diff_data[25])
            axarr[2,3].axis('off')
            axarr[3,3].imshow(diff_data[35])
            axarr[3,3].axis('off')
